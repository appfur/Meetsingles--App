...
class AddEducationLevelBottomSheet extends StatefulWidget {
  const AddEducationLevelBottomSheet({super.key});

  @override
  State<AddEducationLevelBottomSheet> createState() => _AddEducationLevelBottomSheetState();
}

class _AddEducationLevelBottomSheetState extends State<AddEducationLevelBottomSheet> {
  String selectedItem = '';
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          TextWidget(
            text: "Select the level of education",
...
void showAddEducationLevelBottomSheet(
  ...
  showModalBottomSheet(
    ...
    builder: (BuildContext context) {
      return AddEducationLevelBottomSheet();
    },
  );
}
