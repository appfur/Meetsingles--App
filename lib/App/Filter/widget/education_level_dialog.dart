...
class EducationLevelDialog extends StatefulWidget {
  const EducationLevelDialog({super.key});

  @override
  State<EducationLevelDialog> createState() => _EducationLevelDialogState();
}

class _EducationLevelDialogState extends State<EducationLevelDialog> {
