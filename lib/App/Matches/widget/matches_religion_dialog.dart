...
class MatchesReligionDialog extends StatefulWidget {
  const MatchesReligionDialog({super.key});

  @override
  State<MatchesReligionDialog> createState() => _MatchesReligionDialogState();
}

class _MatchesReligionDialogState extends State<MatchesReligionDialog> {
      ...
      child: Column(
        ...
        children: [
          ...
          AppPrimaryButton(
            ...
            onPressed: () {
              matchesController.changeReligionValue(selectedItem);
              Get.back();
            },
          ),
          const SizedBox(
...
void showMatchesReligionDialog(
